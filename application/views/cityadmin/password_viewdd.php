    ...
    <div class="row">         
        ...
        <!--Right Part Start-->
          <div class="right-part col-xs-12 col-sm-8 col-md-8" >
            <div class="white-bg">
                <h2 class="text-center row title">Change Password</h2>
                ...
                <form name="passform" novalidate  id="partnerform">
                  ...
                  {{message}}
                    ...
                    <div class="row">        
                        <div class="input-row">
                            <label class="col-xs-12 col-sm-3 col-md-3"> Old Password : </label>
                        ...
                        <div ng-show="passform.$submitted || passform.oldpass.$touched" class="col-md-offset-3 col-sm-offset-3 ng-hide"> 
                            <span ng-show="passform.oldpass.$error.required && passform.oldpass.$dirty">Old Password is Required.</span> 
                        </div>
                    </div>
                    ...
                    <div class="row">        
                        <div class="input-row">
                            <label class="col-xs-12 col-sm-3 col-md-3"> Enter Password: </label>
                            <span class="col-xs-12 col-sm-9 col-md-9">
                    ...
                    <div class="row">        
                        <div class="input-row">
                            <label class="col-xs-12 col-sm-3 col-md-3"> Confirm Password: </label>
                            <span class="col-xs-12 col-sm-9 col-md-9">
                        ...
                        <div ng-show="passform.$submitted || passform.repassword.$touched" class="col-md-offset-3 col-sm-offset-3 ng-hide"> 
                            ...
                            <span data-ng-show="passform.repassword.$dirty && passform.repassword.$error.passwordNoMatch && !passform.repassword.$error.required"> Password do not match.</small>
                        </div>
                    </div>
