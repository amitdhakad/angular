                                ...
                                <tbody id="list-data">
                                    <?php foreach ($users as $users) { ?>
                                        <tr class="">
                                            ...
                                            <td><?php echo ($users->u_group == '2') ? 'City Admin' : 'Normal User'; ?></td>
                                            ...
                                            <td class="center worker-btn">
                                                ...
                                                <a  class='btn btn-danger' href='javascript:;' onclick='delet(<?php echo $users->u_id ?>)'>Reject</a>
                                            </td>
                                        </tr>
                                    <?php }
                                    ?>
