...
<html>
    <head>
        ...
        <script>
            var site_url = "<?php echo site_url() . 'cityadmin/' ?>";
            var base_url = "<?php echo base_url() ?>";

        </script>
        <script src="<?php echo base_url() . 'assets/frontcss/' ?>js/dirPagination.js"></script>
        <script src="<?php echo base_url() . 'assets/frontcss/' ?>js/cityadmin.js"></script>
                    ...
                    <div class="row">
                       <div class="logo col-xs-12 col-sm-3 col-md-3">
                        <a href="#/">
                         ...
                         <div class="log-in-section col-xs-12 col-sm-9 col-md-9">
                             <div class="header-r-section">
                              <div class="notification" ng-controller='alert'>  
                                  <div class="dropdown deals" dropdown is-open="status.aprovel">
                                    <a dropdown-toggle aria-expanded="false" href="javascript:;">
                                        ...
                                        <i class="badge">{{alertapprovel.length}}</i>
                                    </a>
                                    <ul class="dropdown-menu" role="menu" >
                                        <li>
                                            <a href="javascript:;">
                                                <span>You have {{alertapprovel.length}} new Approval Request </span>
                                            </a>
                                        </li>
                                        <li ng-repeat="approvelalert in alertapprovel">
                                            <a href="#/user" class="notification-user active">
                                                <span class="time"></span>                                                     
                                                <span class="msg">{{approvelalert.comp_person_name}} - {{approvelalert.city_name}}</span>
                                            </a>
                                        </li>                                           
                                    </ul>
                                </div>
                             ...
                             <div  class="login-top">
                                <div class="user-image" ng-init="image='<?php echo $user->comp_person_image ?>'"> 
                                    <img class="img-circle" src="{{image}}" alt="logo" title="" /> </div>
                                <div class="btn-group" dropdown is-open="status.isopen">
                                    <div class="user-name" dropdown-toggle aria-expanded="false">
                                       {{messagess}} welcome, <span ng-init="name='<?php echo $user->comp_person_name ?>'">{{name}}</span> 
                                        <span  class="dropdown-toggle"   type="button" ><span class="caret"></span></span>
                                    </div>
                                    <ul class="dropdown-menu" role="menu">
                                        <li><a href="#/user">Profile </a></li>    
                                        <li><a href="#/password">Change Password </a></li>    
                                        <li><a href="<?php echo site_url() . 'cityadmin/home/logout' ?>">Logout </a></li>
                                    </ul>
                                </div>
                            </div>
                             </div>
