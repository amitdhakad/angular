...
class User extends MY_Worker {
  ...
  /*     * **************
    ...
    public function adddeal() {
        ...
        $this->load->view("cityadmin/add_deals_view", $data);
    }
   ...
   public function add_deal() {
    ...
    public function deals_view() {
        $this->load->view("cityadmin/deals_view");
    }
    ...
    public function your_deal_detail($id) {
        ...
        $this->load->view("cityadmin/your_deals_details_view", $deal);
    }
    ...
    public function query_detail($query_id) {
        ...
        $this->load->view("cityadmin/query_details_view", $data);
    }
    ...
    public function deals_detils() {
        $this->load->view("cityadmin/deals_details_view");
    }
    ...
    public function message() {
        $this->load->view('cityadmin/message_inbox_view');
    }
    ...
    public function details_message($msg_id, $type) {
        ...
        $this->load->view('cityadmin/message_detail_view', $data);
    }
    ...
    public function compose_message() {
        ...
        $this->load->view("cityadmin/compose_message_view", $data);
    }
    ...
    public function alert() {
        if ($this->session->userdata('u_id')) {
            ...
            $data['approvel'] = $this->user_model->user_details(array('comp_city'=>$this->session->userdata('city_id'),'u_group !='=>1,'u_id !='=>$this->session->userdata('u_id'),'u_status'=>'0'));         
